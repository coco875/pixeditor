...
class Scene(QtWidgets.QGraphicsView):
    ...
    def __init__(self, project):
        ...
        # frames
        self.itemList:list[QtWidgets.QGraphicsPixmapItem] = []
        self.canvasList:list[data.Canvas] = []
        # OnionSkin
        self.onionPrevItems = []
        for i in range(3):
    ...
    def mousePressEvent(self, event):
        ...
        # draw on canvas
            ...
            # self.itemList[l] = QtWidgets.QGraphicsPixmapItem(QtGui.QPixmap.fromImage(self.canvasList[l]))
            self.itemList[l].pixmap().convertFromImage(self.canvasList[l])
            self.itemList[l].update()
            print(self.itemList[l].pixmap().size())
        # move or select
